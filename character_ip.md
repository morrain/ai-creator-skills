...
> 💡 **说明**：此文件为项目根目录的项目级 IP 形象规范（`./character_ip.md`）。当此文件存在时，插图、海报及动画视频技能将优先继承本规范。
...
## 3. 外貌 Prompt 标准描述 (Master Visual Prompt)
