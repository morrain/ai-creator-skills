...
- **母版 H1 标题必须在最顶端第一位 (一票否决)**：检查标题备选矩阵是否单独列在最顶部，且**第一备选标题必须严格为母版正文大标题 H1**。若未位于顶部第一位或被遗漏，直接裁决为 `[REJECT]`。
- **正文 100 字约束与 Emoji**：正文必须精炼极简，控制在 **100 字以内**，多使用符合调性的 Emoji 符号（如 🚀, 💡, ⚡, 🔍）增添生动感与结构层次。
