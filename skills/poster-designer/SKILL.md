...
4. **原文长文跳转与引导 (Original Article Reading Guidance)**：
   - 每张海报（特别是海报组图封底页及海报底部卡片）设计时，支持带入引导读者阅读原文长文的手绘胶囊/贴纸组件与原生中文文本（如 `'🔗 点击阅读完整原文'`、`'深度长文已同步，见原文链接 🔗'`），引导感兴趣的用户跳转阅读深度文章。
